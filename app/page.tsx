                    ...
                    <div className="w-full">
                            ...
                            >
                              {callTranscript && callTranscript.map((transcript, index) => (
                                <div key={index}>
                                  {showUserTranscripts ? (
                                    <>
                                      <p><span className="text-gray-600">{transcript.speaker === 'agent' ? "VIP Sales" : "User"}</span></p>
                      ...
                      <div className="text-center mt-4">
                        <div className="flex items-center justify-center">
                          ...
                          <a href="https://zenwareai.com/demo-page#engage_form" className="text-xl font-bold hover:text-gray-300">JOIN THE WAITLIST</a>
                        </div>
                      </div>
                    </div>
                  </div>
